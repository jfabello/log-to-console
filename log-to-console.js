...
class ConsoleLogger {
	 ...
	 * @throws A TypeError if the new log level is not a valid integer, or a RangeError if it is not an integer between 0 and 4.
	 */
	 ...
	 * @param {...*} rest Extra parameters.
	 * @returns {ConsoleLogger} The console logger instance.
	 * @throws A TypeError if the debug message is not a string.
	 */
	...
	debug(message, ...rest) {
		...
		if (typeof message !== "string")
			throw new TypeError(`The message type "${typeof message}" is not valid, it should be a string`);
		if (rest.length === 0) {
	 ...
	 * @param {...*} rest Extra parameters.
	 * @returns {ConsoleLogger} The console logger instance.
	 * @throws A TypeError if the information message is not a string.
	 */
	 ...
	 * @param {...*} rest Extra parameters.
	 * @returns {ConsoleLogger} The console logger instance.
	 * @throws A TypeError if the warning message is not a string.
	 */
	 ...
	 * @param {...*} rest Extra parameters.
	 * @returns {ConsoleLogger} The console logger instance.
	 * @throws A TypeError if the error message is not a string.
	 */
	 ...
	 * @param {...*} rest Extra parameters.
	 * @returns {ConsoleLogger} The console logger instance.
	 * @throws A TypeError if the message is not a string.
	 */
